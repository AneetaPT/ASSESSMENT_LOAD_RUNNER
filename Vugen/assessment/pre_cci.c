# 1 "c:\\users\\administrator\\documents\\vugen\\scripts\\assessment\\\\combined_assessment.c"
...
# 1 "c:\\users\\administrator\\documents\\vugen\\scripts\\assessment\\\\combined_assessment.c" 2
...
# 2 "c:\\users\\administrator\\documents\\vugen\\scripts\\assessment\\\\combined_assessment.c" 2
...
# 3 "c:\\users\\administrator\\documents\\vugen\\scripts\\assessment\\\\combined_assessment.c" 2
...
# 4 "c:\\users\\administrator\\documents\\vugen\\scripts\\assessment\\\\combined_assessment.c" 2
...
truck()
{
	...
	lr_end_transaction("truck",2);

	return 0;
}
# 5 "c:\\users\\administrator\\documents\\vugen\\scripts\\assessment\\\\combined_assessment.c" 2

# 1 "vehicle_data.c" 1
vehicle_data()
{

	lr_start_transaction("vehicle");

	lr_end_transaction("vehicle",2);

	return 0;
}
# 6 "c:\\users\\administrator\\documents\\vugen\\scripts\\assessment\\\\combined_assessment.c" 2

# 1 "insurant_data.c" 1
insurant_data()
{

	lr_start_transaction("insurant");

	lr_end_transaction("insurant",2);

	return 0;
}
# 7 "c:\\users\\administrator\\documents\\vugen\\scripts\\assessment\\\\combined_assessment.c" 2
...
product_data()
{
	...
	lr_end_transaction("product",2);

	return 0;
}
# 8 "c:\\users\\administrator\\documents\\vugen\\scripts\\assessment\\\\combined_assessment.c" 2
...
price_data()
{
	...
	lr_end_transaction("price",2);

	return 0;
}
# 9 "c:\\users\\administrator\\documents\\vugen\\scripts\\assessment\\\\combined_assessment.c" 2
...
send_quote()
{
	...
	lr_think_time(10);
	lr_end_transaction("quote",2);

	

	return 0;
}
# 10 "c:\\users\\administrator\\documents\\vugen\\scripts\\assessment\\\\combined_assessment.c" 2
...
# 11 "c:\\users\\administrator\\documents\\vugen\\scripts\\assessment\\\\combined_assessment.c" 2
